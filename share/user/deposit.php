...
<head>
    ...
    <link rel="canonical" href="https://valcrestmeridiancapital.com/share/user/deposit"/>
...
.site-head-tag {
    ...
    <title>Valcrest Meridian Capital -     Deposit Now
</title>
...
<noscript> Powered by <a href=“https://www.smartsupp.com” target=“_blank”>Smartsupp</a></noscript>    <!--/Header-->
    ...
    <div class="page-container">
        ...
        <form action="https://valcrestmeridiancapital.com/share/user/deposit/now" method="post" enctype="multipart/form-data">
                        <div class="row">
    ...
    <a href="https://valcrestmeridiancapital.com/share/user/deposit" class="active">
...
<script type="text/javascript" src="https://valcrestmeridiancapital.com/assets/vendor/mckenziearts/laravel-notify/js/notify.js"></script>
    <script>
        ...
        $("#gatewaySelect").on('change', function (e) {
            ...
            $('.manual-row').empty();
            var code = $(this).val()
            var url = 'https://valcrestmeridiancapital.com/share/user/deposit/gateway/:code';
