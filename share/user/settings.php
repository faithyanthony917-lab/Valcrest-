...
<head>
    ...
    <link rel="canonical" href="https://valcrestmeridiancapital.com/share/user/settings"/>
...
.site-head-tag {
    ...
    <title>Valcrest Meridian Capital -     Settings
</title>
...
<noscript> Powered by <a href=“https://www.smartsupp.com” target=“_blank”>Smartsupp</a></noscript>    <!--/Header-->
    ...
    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
        <div class="site-card">
            ...
            <div class="site-card-body">
                <form action="https://valcrestmeridiancapital.com/share/user/settings/profile-update" method="post" enctype="multipart/form-data">
                                        <div class="row">
                        <div class="col-xl-3">
                            <div class="mb-3">
                                ...
                                <div class="wrap-custom-file">
                                    ...
                                    <label for="avatar" >
                                        <img
                                            class="upload-icon"
                                            src="https://valcrestmeridiancapital.com/assets/global/materials/upload.svg"
                                            alt=""
                                        />
                            ...
                            <div class="col-xl-6 col-md-12">
                                ...
                                <div class="input-group">
                                    <input type="email" disabled class="form-control disabled"
                                           value="rexxwurld@gmail.com" placeholder="Email Address"
                                    />
                                </div>
                            </div>
                            <div class="col-xl-6 col-md-12">
                            ...
                            <div class="col-xl-6 col-md-12">
                                ...
                                <div class="input-group">
                                    <input
                                        type="text"
                                        class="form-control disabled"
                                        value="Thu, Sep 24, 2026 12:37 AM"
    ...
    <div class="site-card">
        ...
        <div class="site-card-body">
                            ...
                            <a href="https://valcrestmeridiancapital.com/share/user/settings/2fa"
...
-->
    ...
    <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12 col-12">
        ...
        <div class="site-card">
            ...
            <div class="site-card-body">
                <a href="https://valcrestmeridiancapital.com/share/user/change-password" class="site-btn blue-btn">Change Password</a>
            </div>
        </div>
    </div>
</div>
    ...
    <a href="https://valcrestmeridiancapital.com/share/user/settings" class="active">
