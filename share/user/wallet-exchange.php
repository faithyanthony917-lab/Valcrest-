...
<head>
    ...
    <link rel="canonical" href="https://valcrestmeridiancapital.com/share/user/wallet-exchange"/>
...
.site-head-tag {
    ...
    <title>Valcrest Meridian Capital -     Wallet Exchange
</title>
...
<noscript> Powered by <a href=“https://www.smartsupp.com” target=“_blank”>Smartsupp</a></noscript>    <!--/Header-->
    ...
    <div class="page-container">
        ...
        <form action="https://valcrestmeridiancapital.com/share/user/wallet-exchange-now" method="post">
                        <div class="row">
                <div class="col-xl-4 col-md-12">
                    ...
                    <div class="input-group">
                        <select name="from_wallet" class="site-nice-select">
                            <option value="1">Main Wallet (0 USD)</option>
                            <option selected
                                    value="2">Profit Wallet (0 USD)</option>
                        </select>
                    </div>
                </div>
                <div class="col-xl-4 col-md-12">
                ...
                <div class="col-xl-4 col-md-12">
                    ...
                    <div class="input-group">
                        <select name="to_wallet" class="site-nice-select">
                            <option selected
                                    value="1">Main Wallet (0 USD)</option>
                            <option
                                value="2">Profit Wallet (0 USD)</option>
                        </select>
                    </div>
