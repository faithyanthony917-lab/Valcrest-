...
<head>
    ...
    <link rel="canonical" href="https://valcrestmeridiancapital.com/share/user/change-password"/>
...
.site-head-tag {
    ...
    <title>Valcrest Meridian Capital -     Change Password
</title>
            ...
            <div class="site-card">
                <div class="site-card-header">
                    ...
                    <div class="card-header-links">
                        <a href="https://valcrestmeridiancapital.com/share/user/settings" class="card-header-link">Back</a>
                    </div>
                </div>
                <div class="site-card-body">
                    <div class="progress-steps-form">
                        <form action="https://valcrestmeridiancapital.com/share/user/password-store" method="post">
