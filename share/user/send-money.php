...
<head>
    ...
    <link rel="canonical" href="https://valcrestmeridiancapital.com/share/user/send-money"/>
...
.site-head-tag {
    ...
    <title>Valcrest Meridian Capital -     Send Money
</title>
...
<noscript> Powered by <a href=“https://www.smartsupp.com” target=“_blank”>Smartsupp</a></noscript>    <!--/Header-->
    ...
    <div class="progress-steps-form">
        <form action="https://valcrestmeridiancapital.com/share/user/send-money/now" method="post">
                        <div class="row">
                ...
                <div class="col-xl-6 col-md-12">
                    ...
                    <div
                        class="input-info-text">Minimum 10 USD and Maximum 1000000 USD</div>
                </div>
                <div class="col-xl-12 col-md-12 mt-3">
                    <label for="exampleFormControlInput1"
                           class="form-label">Send Money Note (Optional)</label>
                    <div class="input-group">
...
<script type="text/javascript" src="https://valcrestmeridiancapital.com/assets/vendor/mckenziearts/laravel-notify/js/notify.js"></script>
    ...
    <script>
        $('.userCheck').on('change',function (e) {
            ...
            var url = 'https://valcrestmeridiancapital.com/share/user/exist/:email';
