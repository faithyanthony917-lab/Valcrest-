...
<head>
    ...
    <link rel="canonical" href="https://valcrestmeridiancapital.com/share/user/withdraw"/>
...
.site-head-tag {
    ...
    <title>Valcrest Meridian Capital -     Withdraw Now
</title>
            ...
            <div class="site-card">
                <div class="site-card-header">
                    ...
                    <div class="card-header-links">
                        <a href="https://valcrestmeridiancapital.com/share/user/withdraw/account"
                           class="card-header-link">Withdraw Account</a>
                    </div>
                </div>
                <div class="site-card-body">
                    <div class="progress-steps-form">
                        <form action="https://valcrestmeridiancapital.com/share/user/withdraw/now" method="post">
                                                        <div class="row">
...
<script type="text/javascript" src="https://valcrestmeridiancapital.com/assets/vendor/mckenziearts/laravel-notify/js/notify.js"></script>
    <script>
        ...
        $("#withdrawAccountId").on('change',function (e) {
            ...
            if (!isNaN(accountId)) {
                var url = 'https://valcrestmeridiancapital.com/share/user/withdraw/details/:accountId/:amount';
