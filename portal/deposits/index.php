...
<head>
    ...
    <link rel="canonical" href="https://valcrestmeridiancapital.com/portal/deposits"/>
...
<noscript> Powered by <a href=“https://www.smartsupp.com” target=“_blank”>Smartsupp</a></noscript>    <!--/Header-->
    ...
    <div class="page-container">
        ...
        <form action="https://valcrestmeridiancapital.com/portal/deposits/now" method="post" enctype="multipart/form-data">
                        <div class="row">
...
<script type="text/javascript" src="https://valcrestmeridiancapital.com/assets/vendor/mckenziearts/laravel-notify/js/notify.js"></script>
    <script>
        ...
        $("#gatewaySelect").on('change', function (e) {
            ...
            $('.manual-row').empty();
            var code = $(this).val()
            var url = 'https://valcrestmeridiancapital.com/portal/deposits/gateway/:code';
