...
<head>
    ...
    <link rel="canonical" href="https://valcrestmeridiancapital.com/portal/support"/>
...
.site-head-tag {
    ...
    <title>Valcrest Meridian Capital -     Support Tickets
</title>
            ...
            <div class="site-card">
                <div class="site-card-header">
                    ...
                    <div class="card-header-links">
                        <a href="/portal/support" class="card-header-link">Create Ticket</a>
                    </div>
                </div>
                <div class="site-card-body">
                    <div class="site-transactions">
                        
                                                    <form class="support-ticket-form" data-support-ticket><label for="ticket-subject">Subject</label><input id="ticket-subject" name="subject" required maxlength="180" class="form-control"><label for="ticket-category">Category</label><select id="ticket-category" name="category" class="form-control"><option value="general">General</option><option value="account">Account</option><option value="deposit">Deposit</option><option value="withdrawal">Withdrawal</option></select><label for="ticket-message">Message</label><textarea id="ticket-message" name="message" required maxlength="5000" class="form-control"></textarea><button type="submit" class="site-btn blue-btn">Submit ticket</button><p data-request-result role="status"></p></form><div data-ticket-list class="site-transactions"></div>
                                            </div>
                </div>
            </div>
        </div>
...
<script src="/assets/js/portal-actions.js"></script></body>
</html>
