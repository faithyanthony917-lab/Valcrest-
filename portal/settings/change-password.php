...
<head>
    ...
    <link rel="canonical" href="https://valcrestmeridiancapital.com/portal/settings/change-password"/>
            ...
            <div class="site-card">
                <div class="site-card-header">
                    ...
                    <div class="card-header-links">
                        <a href="https://valcrestmeridiancapital.com/portal/settings" class="card-header-link">Back</a>
                    </div>
                </div>
                <div class="site-card-body">
                    <div class="progress-steps-form">
                        <form action="/api/auth/change-password.php" method="post">
...
<script src="/assets/js/change-password.js"></script></body>
</html>
