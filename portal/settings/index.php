...
<head>
    ...
    <link rel="canonical" href="https://valcrestmeridiancapital.com/portal/settings"/>
...
<noscript> Powered by <a href=“https://www.smartsupp.com” target=“_blank”>Smartsupp</a></noscript>    <!--/Header-->
    ...
    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
        <div class="site-card">
            ...
            <div class="site-card-body">
                <form action="https://valcrestmeridiancapital.com/portal/settings/profile-update" method="post" enctype="multipart/form-data">
                                        <div class="row">
                        <div class="col-xl-3">
                            <div class="mb-3">
    ...
    <div class="site-card">
        ...
        <div class="site-card-body">
                            ...
                            <a href="https://valcrestmeridiancapital.com/portal/settings/2fa"
...
-->
    ...
    <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12 col-12">
        ...
        <div class="site-card">
            ...
            <div class="site-card-body">
                <a href="https://valcrestmeridiancapital.com/portal/settings/change-password" class="site-btn blue-btn">Change Password</a>
            </div>
        </div>
    </div>
</div>
    ...
    <a href="https://valcrestmeridiancapital.com/portal/settings" class="active">
